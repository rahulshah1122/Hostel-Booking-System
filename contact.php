...
<body>
 ...
 <!-- to set login logout session dynamically -->
  ...
  <section id="contact" class="section-p1">
    ...
    <div class="contactme">
      <h5>Name</h5>
      <input type="text" name="filter" id="contactname" value="" autocomplete="off" placeholder="Your Name">
    </div>

    <div class="contactme">
      <h5>Gmail</h5>
      <input type="text" name="filter" id="contactgmail" value="" autocomplete="off" placeholder="Your gmail">
    </div>

    <div class="contactme">
      <h5>Message</h5>
      <input type="text" name="filter" id="contactmessage" value="" autocomplete="off" placeholder="Type Your Message">
    </div>
    <div class="contactme" id="contactsubmit">
      <button class="clickbuttons">Submit</button>
    </div>
  </section> 
